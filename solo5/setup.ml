...
(* OASIS_START *)
(* DO NOT EDIT (digest: 828f472a515c26d5815094f11dc87fe3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Anil Madhavapeddy"; "Dan Williams"; "Martin Lucina"];
          homepage = None;
          bugreports = None;
          synopsis = "Library support for the Mirage/Solo5 backend";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Env"; "Lifecycle"; "Main"; "MM"; "Time"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-solo5";
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\011N\163\144\t\241X\006\152\001\230\2526k\003\188";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
